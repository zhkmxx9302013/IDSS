#ifndef TTKTEMPMETERWIDGET_H
#define TTKTEMPMETERWIDGET_H
...
*/
class TTK_EXTRAS_EXPORT TTKTempMeterWidget : public QWidget
{
    Q_OBJECT
public:
    explicit TTKTempMeterWidget(QWidget *parent = 0);
